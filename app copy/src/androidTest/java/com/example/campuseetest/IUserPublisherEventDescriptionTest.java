...
public class IUserPublisherEventDescriptionTest {
    ...
    @Test
    public void userPublisherEventDescriptionTest() throws UiObjectNotFoundException {
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.TextViewTitle), withText("Current Event Details"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView3.check(matches(withText("Current Event Details")));
